...
enum dtl_dtype {
    ...
    DTL_DTYPE_INT_ARRAY = DTL_DTYPE_INT & DTL_DTYPE_ARRAY_BIT,
    DTL_DTYPE_DOUBLE_ARRAY = DTL_DTYPE_DOUBLE & DTL_DTYPE_ARRAY_BIT,
    DTL_DTYPE_TEXT_ARRAY = DTL_DTYPE_TEXT & DTL_DTYPE_ARRAY_BIT,
    DTL_DTYPE_BYTES_ARRAY = DTL_DTYPE_BYTES & DTL_DTYPE_ARRAY_BIT,
