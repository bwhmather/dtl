...
void EvaluateArrayCommand::accept(CommandVisitor& visitor) const {
...
void EvaluateShapeCommand::accept(CommandVisitor& visitor) const {
...
void CollectArrayCommand::accept(CommandVisitor& visitor) const {
...
TraceArrayCommand::TraceArrayCommand(
    dtl::UUID uuid_,
    std::shared_ptr<const dtl::ir::ArrayExpression> expression_
) : uuid(uuid_), expression(expression_) {};

void TraceArrayCommand::accept(CommandVisitor& visitor) const {
...
void ExportTableCommand::accept(CommandVisitor& visitor) const {
